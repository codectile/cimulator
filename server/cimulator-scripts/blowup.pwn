...
public OnGameModeInit()
{
	...
	AddPlayerClass(0,132.3336,-67.6250,1.5781,270.0000,0,0,0,0,0,0);
	...
	CR_CreateColVolume(0, obj[0], 1221, 1.0, 135.68100, -91.73073, 1.06152,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(1, obj[1], 1221, 1.0, 134.53696, -91.79777, 1.06152,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(2, obj[2], 1221, 1.0, 133.09566, -91.88223, 1.06152,   0.00000, 0.00000, 0.00000, 1);

	CR_CreateColVolume(3, obj[3], 1221, 1.0, 131.76138, -91.96041, 1.06152,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(4, obj[4], 1221, 1.0, 134.45720, -91.80853, 3.18867,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(5, obj[5], 1221, 1.0, 133.84770, -91.83816, 2.07358,   0.00000, 0.00000, 0.00000, 1);

	CR_CreateColVolume(6, obj[6], 1221, 1.0, 132.42287, -91.92165, 2.07358,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(7, obj[7], 1221, 1.0, 135.06685, -91.76672, 2.07358,   0.00000, 0.00000, 0.00000, 1);
	CR_CreateColVolume(8, obj[8], 1221, 1.0, 133.13399, -91.89931, 3.18867,   0.00000, 0.00000, 0.00000, 1);

	CR_CreateColVolume(9, obj[9], 1221, 1.0, 133.73849, -91.85670, 4.15000,   0.00000, 0.00000, 0.00000, 1);
	return 1;
}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	{
	    if(!CR_IsIndexAvailable(10))
            CR_DestroyColVolume(10);
		...
		CR_CreateColVolume(10, bullet, 19342, 1.5, x + 5 * floatsin(-angle, degrees), y + 5 * floatcos(-angle, degrees), z,   0.00000, 0.00000, 0.00000, 1);
